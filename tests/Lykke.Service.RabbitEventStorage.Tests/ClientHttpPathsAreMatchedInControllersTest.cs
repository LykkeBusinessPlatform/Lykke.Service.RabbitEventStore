...
using Lykke.Service.RabbitEventStorage;
using Lykke.Service.RabbitEventStorage.Client;
using Microsoft.AspNetCore.Mvc;
using Refit;
using Xunit;

namespace Lykke.Service.RabbitEventStorage.Tests
{
    public class ClientHttpPathsAreMatchedInControllersTest
    {
        ...
        {
            var clientInterface = typeof(IRabbitEventStorageClient);
