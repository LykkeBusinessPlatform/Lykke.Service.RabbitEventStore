...
using Lykke.Service.RabbitEventStorage.Settings;
...
namespace Lykke.Service.RabbitEventStorage
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "RabbitEventStorage API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "RabbitEventStorageLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.RabbitEventStorageService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("RabbitEventStorage", channelOptions =>
                        {
